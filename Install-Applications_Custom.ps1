...
#region Trend Micro
try {
    Start-Process -filepath msiexec.exe -ErrorAction Stop -ArgumentList '/i', 'C:\TCS\BaseApps\Agent-Core-Windows-20.0.1.233.x64.msi', '/quiet' -Wait
...
try {
    Start-Process -filepath 'C:\TCS\BaseApps\WindowsSensor.exe' -ArgumentList "/install /quiet /norestart CID=58CE029866E14481A529D5E495AEB242-76  NO_START=1" -Wait
...
#region Qualys
try {
    Start-Process -filepath 'C:\TCS\BaseApps\QualysCloudAgent.exe' -ArgumentList "CustomerId={183554fa-0bc8-cb39-837d-10f521fe6a8b} ActivationId={8cae7032-f75e-4160-a50a-ebf12196aff9} WebServiceUri=https://qagpublic.qg1.apps.qualys.eu/CloudAgent/" -Wait
...
try {
    Start-Process -filepath 'C:\TCS\BaseApps\JRE8_up241_x64.exe' -ArgumentList "/s REBOOT=ReallySuppress" -Wait -PassThru |out-file "C:\TCS\JavaInstall.txt"
    Start-Process -filepath 'C:\TCS\BaseApps\JRE8_up241_x86.exe' -ArgumentList "/s REBOOT=ReallySuppress" -Wait -PassThru |out-file "C:\TCS\JavaInstall.txt"
...
Import-Certificate -FilePath C:\TCS\BaseApps\ZscalerRootCertificate-2048-SHA256.crt -CertStoreLocation Cert:\LocalMachine\Root |out-file "C:\TCS\ZScaler.txt"
#endregion
...
try 
{
	$taskaction = New-ScheduledTaskAction -Execute "C:\TCS\BaseApps\TrendActivator.bat"
...
try {
    Start-Process -filepath 'C:\TCS\BaseApps\LGPO\LGPO.exe' -ArgumentList "/g C:\TCS\BaseApps\LGPO\Backup\{CB7407B8-C6C2-48E8-ACC9-7710AD73D131}\" -Wait
